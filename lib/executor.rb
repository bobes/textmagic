module TextMagic
  ...
  class API
    ...
    class Executor
      ...
      # gateway. This is a low-level generic method used by other API methods
      # from TextMagic::API class. You should never need to use this method
      # directly.
      # Parameters specified in the +options+ hash will be added to URI.
